            ...
            {/*Navigation*/}
                <Row style={{paddingTop:"20px"}}>
                    ...
                    <div style={{border:"1px solid black", height:"700px", width:"700px", position:"absolute",
                        ...
                        <div style={{display:"inline-block", width:"350px", height:"650px", border:"1px solid blue", marginLeft:"20px", marginTop:"25px"}}></div>
                        <div style={{display:"inline-block",position:"relative", width:"300px", height:"650px", border:"1px solid red",marginLeft:"10px", marginTop:"25px"}}>
                            <div style={{position: "absolute", bottom: "0px", width: "100%", height: "100px", border: "1px solid green"}}>
                                <NavLink tag={Link} activeClassName="current" exact to="/signUp">
