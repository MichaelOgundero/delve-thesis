...
@JsonProperty("genres")
private List<DetailsGenre> genres = null;
...
private List<DetailsProductionCompany> productionCompanies = null;
@JsonProperty("production_countries")
private List<DetailsProductionCountry> productionCountries = null;
...
private List<DetailsSpokenLanguage> spokenLanguages = null;
@JsonProperty("status")
